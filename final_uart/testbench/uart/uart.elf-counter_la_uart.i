# 0 "counter_la_uart.c"
# 1 "/home/kai/caravel-soc_fpga-lab/final_uart2/testbench/uart//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_uart.c"
...
# 42 "counter_la_uart.c"
void main()
{

    int mask;
# 73 "counter_la_uart.c"
 ...
 while (1) {
  if ((*(volatile uint32_t*) ((0xf0000000L + 0x3020L) + 12)) > 0x1F4) {
   (*(volatile uint32_t*)0x2600000c) = 0xAB410000;
   break;
  }
 }
# 155 "counter_la_uart.c"
 mask = irq_getmask();
 mask |= 1 << 2;
 irq_setmask(mask);
